...
- All Amazon research must be done manually by Elise on Amazon.com — no scraping, no automated tools
- BSR is a directional signal, not a guarantee of demand
...
| 60–79 | Revise and validate — identify which weak categories can be improved |
| Below 60 | Reject or park — do not invest production resources |

**Note:** A Copyright/IP Safety score of 3/10 or below is disqualifying regardless of total score.
